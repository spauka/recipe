...
\begin{enumerate}
  ...
  \item Hit \boxed{speed/ramp}, then set up the rotation speed (500rpm for step 1). Hit \boxed{enter} when done.
  \item Hit \boxed{speed/ramp}, then set up the ramp slope (500rpm/sec ramp for step 1). Hit \boxed{enter} when done.
