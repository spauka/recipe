...
\begin{enumerate} [noitemsep,nolistsep] % TODO: Confirm all these items are correct. Filled in from memory....
  ...
  \item Select the recipe you wish to edit and hit \fbox{Open}.
...
\end{enumerate}
\item Once the vacuum stage is complete, open the \fbox{Systems} menu and put the tool into \fbox{Auto} mode.
...
\item In the bottom left, hit \fbox{Start} to begin the processing. Ensure that the argon begins to flow at the correct rate (15 sccm).
      Once deposition begins, ensure that you can see a ring of plasma around the source being sputtered. Open the power source monitor (\fbox{Devices}$\rightarrow$\fbox{DC PSU} for DC or
      \fbox{Devices}$\rightarrow$\fbox{RF Generator} for RF)
...
\item If the Vacuum dialog is missing, it can be found in \fbox{Devices}$\rightarrow$\fbox{Vacuum System}.
